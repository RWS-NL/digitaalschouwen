...
import os
import cv2
from utils_dgx_copy import decode_netout, compute_overlap, compute_ap
...
class YOLO(object):
    ...
    def train(self, train_imgs,     # the list of images to train the model
        ...
        ReduceLR = ReduceLROnPlateau(monitor='val_loss',
                                  factor=0.1,
                                  patience=5)
        csvlogger = CSVLogger('logs/%s' %(saved_weights_name.replace('h5','csv')), separator=',', append=False)
        ############################################
...
#                                 callbacks        = [checkpoint, tensorboard],
                                 callbacks        = [checkpoint,checkpoint2,ReduceLR,csvlogger],
                                 workers          = 3,
                                 max_queue_size   = 8)
        ...
        logfile = 'logs/%s' %(saved_weights_name.replace('h5','txt'))
